...
export const viralCaptionTemplate: BuiltInTemplate = {
    ...
    generateCode: (values) => {
        const line1 = sanitizeString(values.line1, "MOST PEOPLE THINK SUCCESS");
        const line2 = sanitizeString(values.line2, "IS JUST LUCK");
        const highlightColor = values.highlightColor || "#FFD54F";
        const fontSize = values.fontSize || 80;
        const bgStyle = values.bgStyle || "gradient";

        const bgStylesUrl: Record<string, string> = {
